...
export const MicIcon: React.FC<{ active: boolean }> = ({ active }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${active ? 'animate-pulse' : ''}`} viewBox="0 0 20 20" fill="currentColor">
